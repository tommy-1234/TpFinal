...
<div class="wrapper row4">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <form action="<?php echo FRONT_ROOT."JobOffer/Detail"?>" method="post">
      <br>
          ...
          <tbody>     
                <?php foreach($JobOfferList as $JobOffer){?>
                  <tr>
                    ...
                    <td>
                      <!--
                      <button type="submit" class="btn" name="idJobOffer" value="<?php // echo $JobOffer->getCompany()->getIdCompany() ?>"> More Details </button>
                       -->
                    </td>
